...
const CreatePost = () => {
  ...
  return (
    ...
    <div>
      ...
      <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create imaginative and visually stunning images through DALL_E AI and share them with the community</p>
    </div>
    ...
    <div>
      ...
      <div className='relative mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 justify-center items-center'>
      {form.photo?(
